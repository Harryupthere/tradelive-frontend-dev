  ...
  const addRecentActivity = async () => {
    try {
      const payload = {
        ...
        table_id: 0,
        meta: { route: `risk-of-ruin-calculator` },
      };
    ...
    <div className="risk-of-ruin-calculator">
      <div className="container">
        <div className="risk-of-ruin-calculator__header">
          ...
          <h1 className="risk-of-ruin-calculator__title">
            ...
            <div className="results-section">
              ...
              <div className="results-grid">
                <div className="result-card">
                  ...
                  <div className="result-value drawdown">
                    {results.riskOfDrawdown}
                  </div>
                </div>

                <div className="result-card">
                  <div className="result-label">Risk of Ruin:</div>
                  <div className="result-value ruin">{results.riskOfRuin}</div>
                </div>
              </div>
        ...
        <div className="info-section">
          <div className="info-card">
            ...
            <p>
              The risk of ruin calculator is an advanced tool to evaluate a
              trading system's probability of loss.
            </p>
            <p>
              By inputting the system's metrics, you can calculate the
              probability to hit a specific drawdown or ruin.
            </p>
          </div>
          ...
          <div className="info-card">
            ...
            <p>
              Risk of ruin is defined as a probability of a specific loss from
              the original balance, ie if you started with $1000, calculating a
              risk of ruin of 40% would tell you the probability to lose 40% of
              your balance or $400. As the equity grows, the risk of ruin
              decreases.
            </p>
            <p>
              Risk of Drawdown is always the same through the lifetime of your
              account since your account's peak is always increased once the
              equity grows (drawdown is the calculation of highest
              peak-to-valley decrease).
            </p>
          </div>
          ...
          <div className="info-card">
            ...
            <ul>
              <li>
                <strong>Win rate (%)</strong> – how many of the trades end up in
                profit, in percentage.
              </li>
              <li>
                <strong>Average win</strong> – average winning trade, in money
                terms.
              </li>
              <li>
                <strong>Average loss</strong> – average losing trade, in money
                terms.
              </li>
              <li>
                <strong>Risk per trade (%)</strong> – how much of the account
                you risk per trade, in percentage.
              </li>
              <li>
                <strong>Loss level (%)</strong> – the drawdown level you want to
                calculate the risk for.
              </li>
              <li>
                <strong>Number of trades</strong> – the number of trades in your
                sample.
              </li>
            </ul>
          </div>
