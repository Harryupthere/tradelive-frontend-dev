...
const DepositAndWithdraw: React.FC = () => {
  ...
  const [depositAndWithdrawTutorials] = useState([
    ...
    <div className="profile-page">
      <div className="">
        <div className="profile-page__section-header">
          <h2>Deposit and Withdraw Tutorials</h2>
        </div>
        ...
        <div className="profile-page__table-container">
          <table className="profile-page__table">
            ...
            <tbody>
              {depositAndWithdrawTutorials?.length > 0 ? (
                depositAndWithdrawTutorials?.map((t: any, index) => (
                  <tr key={t.id}>
