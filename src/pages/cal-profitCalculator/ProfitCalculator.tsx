...
const ProfitCalculator: React.FC = () => {
  ...
  const [profitRatio, setProfitRatio] = useState("100:1");
  ...
  const profitRatios = ["50:1", "100:1", "200:1", "400:1", "500:1"];
  ...
  const calculateProfit = () => {
    ...
    const leverage = parseInt(profitRatio.split(":")[0]);
    ...
    if (quoteCurrency === accountCurrency) {
      profit = (contractSize * exchangeRate) / leverage;
    } else if (baseCurrency === accountCurrency) {
      profit = contractSize / leverage;
    } else {
      profit = (contractSize * exchangeRate) / leverage;
    }

    setResult(parseFloat(profit.toFixed(2)));
  };

  const handleReset = () => {
    setCurrencyPair("EURUSD");
    setAccountCurrency("USD");
    setProfitRatio("100:1");
    setTradeSize(1);
    ...
    <div className="profit-calculator">
      <div className="container">
        <div className="currency-converter__header">
          ...
          <h1 className="currency-converter__title">Profit Calculator</h1>
        </div>
        ...
        <div className="calculator-card">
          ...
          <div className="result-section">
            ...
            <div className="button-group">
              ...
              <button className="btn btn-calculate" onClick={calculateProfit}>
                Calculate
              </button>
            </div>
          </div>
        ...
        <div className="info-section">
          <p className="info-description">
            Calculate your exact profit or loss before entering a position and
            plan your trading plan accordingly. Using the forex profit
            calculator you can adjust your trade size or take profit and stop
          ...
          <p className="info-text">
            ...
            trade Direction - either buy or sell (long or short). The profit
          ...
          {/* <p className="info-text">
            For example, for a USD account with leverage 1:100 and the current forex prices (as of writing), the profit cost would be:
          </p>
          ...
          <p className="info-text">
            ...
            potential profit or loss of a trade. Our Forex profit loss
            calculator can be used as a take profit or stop loss calculator
            whether you’re actually using sl/tp values or closing the trade
            manually. If you wish to calculate your profit with a more advanced
          ...
          <p className="info-text">
            Profit In foreign exchange is the difference between your open and
            close price. When trading forex, you can open a trade in 2
            directions: buy (long) and sell (short). To make a profit with a buy
            trade, you need to buy a currency at a low price and sell at a
            higher price. To make a profit with a sell trade, you need to sell a
            currency at a high price and buy it back at a lower price. For
            example, using our calculator as a gold profit calculator, if you
            buy 100 units (standard lot of gold) of gold at $1890.00 and sell it
            at $1891.00, you would profit $100.
          </p>

          {/* <h3 className="info-heading">How much profit do I have in my account?</h3>
          <p className="info-text">
            That would depend on your account leverage and open positions. Each open trade in your account takes away from your available profit.
          </p>
          <p className="info-text">
            For example, a trade of 1 lot EURUSD would require $100,000 times the EURUSD rate in profit (to convert from base currency to deposit currency), so if price is 1.1912, this would mean a profit of $119,120, before leverage is applied.
          </p> */}
        </div>
      </div>
    </div>
