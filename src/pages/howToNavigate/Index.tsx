...
const HowToNavigate: React.FC = () => {

  const [howToNavigateTutorials] = useState([
    ...
    <div className="profile-page">
      <div className="">
        <div className="profile-page__section-header">
          <h2>How To Navigate Tutorials</h2>
        </div>
        ...
        <div className="profile-page__table-container">
          <table className="profile-page__table">
            ...
            <tbody>
              {howToNavigateTutorials?.length > 0 ? (
                howToNavigateTutorials?.map((t: any, index) => (
                  <tr key={t.id}>
