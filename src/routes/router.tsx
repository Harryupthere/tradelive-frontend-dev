...
import TermsPage from "../pages/term-and-condition/terms-and-conditions";
import ProductPlatformDetail from "../pages/productPlatform";
import RegistrationPricingPlans from "../pages/pricingPlans/registration-plan";
import RegistrationCheckout from "../pages/checkout/registration-checkout";
import LiveSessionCheckout from "../pages/checkout/live-session-checkout";
...
const Router = () => {
  ...
  const router = createBrowserRouter([
    ...
    { path: `${base}Terms&Conditions`, element: <TermsPage /> },

    // { path: `${base}`, element: <CountdownPage /> },
    ...
    { path: `${base}payment-failure`, element: <PaymentFailure /> },
    {
      ...
      children: [
...

        {
          ...
          element: (
            <ProtectedPage condition={!!isUser}>
              <RegistrationPricingPlans />
            </ProtectedPage>
          ),
        },
        {
          path: `${base}registration-checkout`,
          element: (
            <ProtectedPage condition={!!isUser}>
        ...
        {
          path: `${base}live-session-checkout`,
          element: (
            <ProtectedPage condition={!!isUser}>
              <LiveSessionCheckout />
            </ProtectedPage>
        ...
        {
          path: `${base}platform-overview/:id`,
          element: (
            <ProtectedPage condition={!!isUser}>
