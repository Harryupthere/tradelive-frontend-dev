...
export interface ProductPlatformI {
  id: number;
  title: string;
  subtitle:string;
  type?: string;
...
interface ProductPlatformCardProps {
  course: ProductResourceI;
}

const ProductPlatformCard: React.FC<ProductPlatformCardProps> = ({ course }) => {

  const navigate = useNavigate()
  return (
    <div className="course-card" onClick={() => navigate(`${base}platform-overview/${course.id}`)}>
